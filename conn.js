...
var nme = `./media/vid/${Date.now()}.mp4`
 ...
 conn.sendMessage(sender, { audio: fs.readFileSync(ran), mimetype: 'audio/mp4', fileName: `${data.title}.mp3` }, { quoted: msg })
fs.unlinkSync(nme)
fs.unlinkSync(ran)
 })
...
reply(mess.wait)
data = await caliph.downloader.youtube.ytmp4(q)
conn.sendMessage(sender, { video: await getBuffer(data.result), caption: data.title }, { quoted: msg })
...
conn.sendMessage(sender, buttonMessage, { quoted: msg })
})
}
           break
